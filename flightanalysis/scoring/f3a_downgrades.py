...
dgs = DownGrades([
    dg("end_track_y", "track_y", Measurement.track_y, None, sels.last(), F3A.single.track),
    dg("end_track_z", "track_z", Measurement.track_z, None, sels.last(), F3A.single.track),
    dg("end_roll_angle", "roll", Measurement.roll_angle, None, sels.last(), F3A.single.roll),
    dg("speed", "speed", Measurement.speed_ratio, sms.lowpass(cutoff=0.25, order=5), None, F3A.intra.speed),
    ...
    dg("stallturn_speed", "speed", lambda fl, tp: Measurement.speed_value(fl, tp, g.PZ()), None, None, F3A.intra.stallturn_speed),
    dg("stallturn_roll_angle", "roll", Measurement.roll_angle_z, sms.lowpass(cutoff=1, order=5), None, F3A.intra.roll),
