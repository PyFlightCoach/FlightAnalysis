...
dgs = DownGrades([
    ...
    dg("spin_alpha", "alpha", measures.spin_alpha_iac(), None, sels.before_recovery(rot=np.pi/4), Glider.intra.pos_autorotation_alpha),#alpha > 7.5 until last 45 degrees of turn
    ...
    dg("snap_alpha", "alpha", measures.alpha_iac(), None, sels.autorotation(brot=np.pi/4, rrot=np.pi/2), Glider.intra.autorotation_alpha),#alpha > 7.5
