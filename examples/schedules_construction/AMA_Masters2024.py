...
Mast24FC_def = SchedDef([
    ...
    f3amb.create(ManInfo("Triang-1/4rolls", "trgle-1/4rolls", 3,Position.CENTRE,
    ...
    f3amb.create(ManInfo(
            "Figure 9-roll", "fig9-roll", k=3, position=Position.END, 
    ...
    f3amb.create(ManInfo("Humpty 1/2rolls", "humpty", 2, Position.END,
    ...
    f3amb.create(ManInfo(
            "Loop-intgrolls ", "loopRlls", k=3, position=Position.CENTRE, 
            start=BoxLocation(Height.MID, Direction.UPWIND, Orientation.UPRIGHT),
            end=BoxLocation(Height.MID)
        ),[
...
#####################################
    f3amb.create(ManInfo(
            "1/2SquareCorner-Rolls", "hscRolls", k=2, position=Position.END, 
...
#####################################
    f3amb.create(ManInfo(
            " 1/2 Cloverleaf-rolls", "hClovRolls", k=5, position=Position.CENTRE, 
...
#####################################
    f3amb.create(ManInfo(
            "Rev Fig Et-Rolls", "rEtRolls", k=3, position=Position.END, 
            start=BoxLocation(Height.TOP, Direction.DOWNWIND, Orientation.UPRIGHT),
            end=BoxLocation(Height.TOP)
        ),[
            f3amb.loop(-np.pi*2/8),
...
#####################################
    f3amb.create(ManInfo("Fig Z -snap", "figzSnap", 4, Position.CENTRE,
...
#####################################
    f3amb.create(ManInfo("Comet-Rolls", "ComRolls", k=3, position=Position.END, 
            start=BoxLocation(Height.TOP, Direction.DOWNWIND, Orientation.UPRIGHT),
            end=BoxLocation(Height.BTM)
        ),[
            f3amb.loop(-np.pi*2/8), 
...
#####################################
    f3amb.create(ManInfo("Figure S-roll", "figSRoll", k=3, position=Position.CENTRE, 
            start=BoxLocation(Height.TOP, Direction.UPWIND, Orientation.UPRIGHT),
            end=BoxLocation(Height.BTM)
        ),[
            MBTags.CENTRE,
